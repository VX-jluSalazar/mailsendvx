...
{
    public function getDefaultHtmlContent(string $eventName, string $customerRegisteredEvent, string $newsletterRegisteredEvent): string
    {
    ...
    public function getDefaultTextContent(string $eventName, string $customerRegisteredEvent, string $newsletterRegisteredEvent): string
    {
        if ($eventName === $customerRegisteredEvent) {
